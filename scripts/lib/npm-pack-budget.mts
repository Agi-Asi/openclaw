...
// level while allowing that mirrored runtime surface, the installed agent's
// bundled user documentation, and the self-contained worker deployment bundle.
const NPM_PACK_UNPACKED_SIZE_BUDGET_BYTES = 205 * 1024 * 1024;
