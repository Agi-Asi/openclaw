...
export const icons = {
  ...
  archiveRestore: strokeIcon(svg` <rect width="20" height="5" x="2" y="3" rx="1" />
    ...
    <path d="M12 12v6" />`),
  shredder: strokeIcon(svg` <path d="M4 13V4a2 2 0 0 1 2-2h8a2.4 2.4 0 0 1 1.706.706l3.588 3.588A2.4 2.4 0 0 1 20 8v5" />
  ...
  chevronDown: strokeIcon(svg`<path d="m6 9 6 6 6-6" />`),
  ...
  listEnd: strokeIcon(svg` <path d="M16 5H3" />
    <path d="M16 12H3" />
    <path d="M9 19H3" />
