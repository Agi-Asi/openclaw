...
export const en: TranslationMap = {
  ...
  sessionsView: {
    ...
    sessionsAhead: "{count} ahead",
    slotsBusy: "{busy} of {capacity} slots busy",
  ...
  tasksPage: {
    ...
    wait: {
      slots: "Execution slots occupied · {busy}/{capacity}",
      ahead: "Tasks ahead · {count}",
    },
    status: {
      queued: "Queued",
      running: "Running",
