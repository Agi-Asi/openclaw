...
export const en: TranslationMap = {
  ...
  modelProviders: {
    ...
    profiles: {
      ...
      orderHint: "tried in priority order",
      automaticHint: "automatic rotation",
      include: "Include",
      includeFor: "Include {account} in rotation",
      addAccount: "Add account",
      lastUsed: "Last used {time} ago",
      cooldown: "Available again in {time}",
      clearCooldown: "Try again now",
      clearCooldownFor: "Try {account} again now",
      cooldownCleared: "Account is available to try again.",
      reorder: "Reorder {account}, currently priority {position}",
      automaticFor: "{account}, automatic rotation",
      primaryFor: "{account} is primary",
      priorityFor: "{account} is priority {position}",
      notInRotationFor: "{account} is not in rotation",
    },
    apiKey: {
      label: "API key",
      sourceConfig: "API key in config",
      sourceEnv: "API key from environment",
      sourceEnvNamed: "API key from {name}",
      sourceProfiles: "API key profiles: {count}",
