...
export const en: TranslationMap = {
  ...
  configView: {
    ...
    appearance: {
      intro: "Theme, accessibility, chat, and sidebar preferences for this Control UI client.",
      theme: "Theme",
      chooseTheme: "Choose a theme family.",
      colorVision: "Color vision",
      colorVisionHint: "Adjust semantic colors for common color-vision differences.",
      colorVisionCustomThemeHint: "Use a built-in theme to apply color-vision palettes.",
      colorVisionOptions: {
        standard: "Standard",
