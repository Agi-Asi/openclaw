...
export const en: TranslationMap = {
  ...
  memoryPage: {
    ...
    sharing: {
      ...
      intro:
        "Create reviewed projection copies and review one-way postbox deposits without granting access to a private store.",
      statusTitle: "Sharing status",
      postboxMode: "Postbox mode",
      postboxOff: "Off",
      postboxReviewRequired: "Review required",
      projectionCount: "Projections",
      postboxCount: "Postbox items",
      requestFailed: "The sharing request could not be completed.",
      completeRequiredFields:
        "Complete the required projection fields and choose either an expiry or an audited no-expiry reason.",
      invalidAgentSharedTarget: "Agent-shared projections must target the selected agent.",
      previewRequired: "Preview the projection before creating it.",
      targets: {
      ...
      projection: {
        title: "Reviewed projection",
        description: "A projection creates one reviewed copy for a named non-private audience.",
        id: "Projection to refresh",
        sourceRevision: "Source revision",
        targetKind: "Target kind",
        targetId: "Target id",
        targetStoreId: "Reviewed-copy target store id",
        purpose: "Purpose",
        preview: "Human-readable preview",
        expiry: "Expiry",
        noExpiryReason: "No-expiry audit reason",
        content: "Reviewed copy",
        previewAction: "Preview",
        registerTarget: "Register target store",
        create: "Create projection",
        refresh: "Refresh projection",
      },
      projections: "Existing projections",
      emptyProjections: "No projections are available for this profile.",
      impact: "Prior exposure impact",
      priorExposure: "{count} prior exposure records",
      revoke: "Revoke",
      postbox: "Postbox review",
      emptyPostbox: "No quarantined postbox items are available.",
      inspect: "Inspect",
      approve: "Approve",
      reject: "Reject",
      purge: "Purge",
