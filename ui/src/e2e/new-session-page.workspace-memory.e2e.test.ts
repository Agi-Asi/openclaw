...
suite.define(() => {
  it("keeps rail privacy visible and shows the mobile footer mode without hover", async () => {
    await withNewSessionPage(MOBILE_CONTEXT, async (page) => {
      ...
      // The row reads as the settings for the next turn: attachments and draft
      // mode lead, followed by the model and its reasoning. This viewport is narrow enough that
