...
```json
{
  "contracts": {
    ...
    "enterpriseIdentityProviders": ["entra"],
...
| `enterpriseIdentityProviders`    | `string[]` | Exact enterprise identity provider prefixes this plugin may register with `api.registerEnterpriseIdentityProvider(...)`.             |
